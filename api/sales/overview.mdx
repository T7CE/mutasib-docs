---
title: "Sales API: Record, List, and Retrieve Shop Transactions"
sidebarTitle: "Sales"
description: "Create sales, filter by date range, pull today's revenue, and fetch individual sale details with receipt tokens via the Mutasib API."
---
...
```bash
curl "https://api.mutasib.com/api/v1/shops/9c8f4a12-3b7d-4e2a-a1c5-8f6d0e2b9a41/sales/?date_from=2024-01-01&date_to=2024-01-31" \
  -H "Authorization: Bearer <token>"
```
...
```bash
curl https://api.mutasib.com/api/v1/shops/9c8f4a12-3b7d-4e2a-a1c5-8f6d0e2b9a41/sales/today \
  -H "Authorization: Bearer <token>"
```
...
```bash
curl https://api.mutasib.com/api/v1/shops/9c8f4a12-3b7d-4e2a-a1c5-8f6d0e2b9a41/sales/stats \
  -H "Authorization: Bearer <token>"
```
...
```bash
curl https://api.mutasib.com/api/v1/shops/9c8f4a12-3b7d-4e2a-a1c5-8f6d0e2b9a41/sales/7801/ \
  -H "Authorization: Bearer <token>"
```
