---
title: "Products API: Create and Manage Shop Products"
...
Returns `201 Created` with the uploaded image object containing `id`, `url`, `alt_text`, and `sort_order`.
...
<ResponseField name="cost" type="number">
  Purchase or production cost used for margin calculations.
</ResponseField>
