...
```bash
curl "https://api.mutasib.com/api/v1/shops/9c8f4a12-3b7d-4e2a-a1c5-8f6d0e2b9a41/products/?category_id=7&active_only=true" \
  -H "Authorization: Bearer <your_token>"
```
...
```bash
curl "https://api.mutasib.com/api/v1/shops/9c8f4a12-3b7d-4e2a-a1c5-8f6d0e2b9a41/products/search/?q=olive+oil&active_only=true" \
  -H "Authorization: Bearer <your_token>"
```
...
```bash
curl https://api.mutasib.com/api/v1/shops/9c8f4a12-3b7d-4e2a-a1c5-8f6d0e2b9a41/products/301/ \
  -H "Authorization: Bearer <your_token>"
```
...
```bash
curl -X PATCH https://api.mutasib.com/api/v1/shops/9c8f4a12-3b7d-4e2a-a1c5-8f6d0e2b9a41/products/301/ \
  -H "Authorization: Bearer <your_token>" \
  -H "Content-Type: application/json" \
  -d '{
    "price": 29.99,
...
```bash
curl -X DELETE https://api.mutasib.com/api/v1/shops/9c8f4a12-3b7d-4e2a-a1c5-8f6d0e2b9a41/products/301/ \
  -H "Authorization: Bearer <your_token>"
```
...
```bash
curl -X POST https://api.mutasib.com/api/v1/shops/9c8f4a12-3b7d-4e2a-a1c5-8f6d0e2b9a41/products/301/images/ \
  -H "Authorization: Bearer <your_token>" \
...
```bash
curl -X DELETE https://api.mutasib.com/api/v1/shops/9c8f4a12-3b7d-4e2a-a1c5-8f6d0e2b9a41/products/301/images/5/ \
  -H "Authorization: Bearer <your_token>"
```
