---
title: "Inventory API: Track Stock and Log Movements"
sidebarTitle: "Inventory"
description: "List inventory snapshots, adjust stock levels, monitor low-stock products, and view movement history via the Mutasib API."
---
